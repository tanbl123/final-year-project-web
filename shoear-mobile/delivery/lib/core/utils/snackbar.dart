...
///
/// By default `ScaffoldMessenger` queues snackbars, so rapid actions stack up
/// and the user has to wait for each to time out. These helpers dismiss the
/// current snackbar first so the latest message shows immediately.
